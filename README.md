...
A robot instruction is a string of the letters "L", "R", and "F" on one line. Each robot is processed sequentially, i.e., finishes executing the robot instructions before the next robot begins execution. The maximum value for any coordinate is 50. All instruction strings will be less than 100 characters in length.
...
## Solution
![image](https://user-images.githubusercontent.com/18632445/179131474-0c65e1f2-ebaa-4efc-9a74-6fd7a69e585b.png)
